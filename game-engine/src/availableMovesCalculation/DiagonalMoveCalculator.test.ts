...
describe('DiagonalMoveCalculator', () => {
    let calculator: DiagonalMoveCalculator;

    beforeEach(() => {
        calculator = new DiagonalMoveCalculator();
    });
    ...
    describe('getAvailableMovesOnLineIgnoringKingSafety', () => {
        describe('returns all attacking and non attacking moves', () => {
            test('for white', () => {
                ...
                const result = calculator.getAvailableMovesOnLineIgnoringKingSafety(bishop, board);
